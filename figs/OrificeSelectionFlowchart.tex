...
\begin{tikzpicture}[auto]
  ...
  \node[process,below of=runmodel,node distance=10em] (checkp) {Check all $\Delta p$s against acceptable range};
  \inoutput{below of=ncheck,node distance=10em}{output}{Output results plot}
