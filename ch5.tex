...
\todo{Float placement needs work here. Adjust sizes or group into subfigures.}
...
\IP{1.5}{\fahrenheit} or 0.5\% on an absolute temperature scale.
\begin{figure}[tbp]
  \centering
...
\Cref{tab:tab:SensOrif} displays the results, and it is clear that the effect
