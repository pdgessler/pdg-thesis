...
\chapter{EES Code Listing} \label{app:code}
...
(\Cref{lst:assume,lst:const,lst:ebal,lst:mbal,lst:orifice,lst:prop}) which contain 
the bulk of the equations in the model. \note{This must be updated manually. 
...
settings in the main EES program (\Cref{lst:main}) are used.
\begin{figure}[htbp]
	\centering
